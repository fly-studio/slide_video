...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"   创建 {width}x{height} @ {fps}fps, {duration_seconds}s 测试视频")
        ...
        print(f"\n   ✓ 视频生成成功: test_output.mp4")
        print(f"   总帧数: {writer.get_frame_count()}")
        print(f"   时长: {writer.get_duration_seconds():.2f}s")
